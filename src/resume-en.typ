...
#let experience = [
  ...
  #bullets(
    (
      ...
      [Built backend services and supporting React interfaces for dataset discovery, metadata management, model artifact browsing, experiment metric visualization, and GPU inference orchestration with live log streaming],
